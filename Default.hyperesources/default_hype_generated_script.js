...
var centerpage = $( window ).width() /2;
console.log(centerpage);

$(window).resize(function(){
    
    centerpage = $( window ).width() /2;
    console.log(centerpage);
